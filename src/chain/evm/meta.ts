...
import { fetchTableMeta } from "./reader";
...
/** Cached table metadata. Errors are treated as "table not found" and cached
 *  as null so probing arbitrary names doesn't keep hitting RPC. */
export async function getTableMetaCached(dbRootId: string, tableName: string): Promise<TableMeta | null> {
