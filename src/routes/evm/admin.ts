...
//
// Only mounted when ADMIN_TOKEN is set. Bearer auth via Authorization header.

import { Hono } from "hono";
import { getQueueStats, setQueueConfig } from "../../chain/evm/rpc-queue";
...
adminRouter.get("/queue", (c) => c.json(getQueueStats()));
...
export function isAdminEnabled(): boolean { return !!ADMIN_TOKEN; }
